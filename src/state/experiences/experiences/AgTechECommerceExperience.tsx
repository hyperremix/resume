...
export const AgTechECommerceExperience: TExperience = {
  ...
  roleDescription: (
    <Typography>
      ...
      building a fast, scalable, reliable and maintainable solution from scratch for the trade-in
      process at dealerships. This included being involved and driving the decision making from
      high- to low-level topics revolving the application, what technologies to go for, which
      services to use, team processes as well as conception.
    </Typography>
  ),
  skills: [
    Skill.TypeScript,
